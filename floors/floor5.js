(function() {
  window.zonesFloor5 = [
    ...
    },
    {
      ...
      label: "557",
      color: "#FF6347",
      info: "Отдел образовательных программ, Учебно-методические управления",
    ...
    { id: "el_4", label: "Лифт", color: "#4B0082", info: "", add_info: ""  },    
    ...
    { id: "tT", label: "Общий туалет", color: "#37aa63", info: "", add_info: ""  },
    { id: "tT_2", label: "Общий туалет", color: "#37aa63", info: "", add_info: ""  },
  ];
})();